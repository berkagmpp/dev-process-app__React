...
import adobeQuery from '../../assets/adobe_query.jpg';
import nzheraldGrid from '../../assets/nzherald_grid-with-media.jpg';
import adobeGrid from '../../assets/adobe_grid.jpg';
import nzheraldImg from '../../assets/nzherald_img.jpg';
import adobeImg from '../../assets/adobe_img.jpg';
import adobeImg700 from '../../assets/adobe_img_700vs599.jpg';
                        ...
                        <div className={classes.container}>
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={nzheraldQuery} alt="NZherald's empty space shown on a widescreen (3840px)" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={contentArea} alt="The content area adjustment between general and large display" width="30%" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={adobeQuery} alt="The content area adjustment between general and large display" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={nzheraldGrid} alt="Using CSS grid in NZherald" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={adobeGrid} alt="Using the AEM Grid system in Adobe " /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={nzheraldImg} alt="Defining the width size with the relative unit to automatically adjust the height in NZherald" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={adobeImg} alt="The method of flexibly adjusting the space in the image using the overlaid background image in Adobe" /><br /><br />
                            ...
                            <div className={classes.center}>
                                <div className={classes['img-shadow']}>
                                    <img src={adobeImg700} alt="The images shown on the 700px (left) and 599px(right) screens in Adobe" /><br /><br />
                                    <p className={classes.strong}>Figure 7</p>
